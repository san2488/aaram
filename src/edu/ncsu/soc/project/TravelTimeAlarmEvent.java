...
public class TravelTimeAlarmEvent extends AlarmEvent {
	...
	public TravelTimeAlarmEvent(String eventName, Date initialEventTime, Integer initialPrepTime,
			Integer minPrepTime, String startLocation, String endLocation, Integer initialTravelTime) {
		super(eventName, initialEventTime, initialPrepTime, minPrepTime);
		this.startLocation = startLocation;
		this.endLocation = endLocation;
		// initialize alarm time by subtracting initial ravel and prep times
		this.currentAlarmTime = DateUtils.addMinutes(this.initialEventTime, (initialTravelTime + initialPrepTime) * -1);  
